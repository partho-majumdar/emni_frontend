...
//                 style={{ 
//                   minHeight: '120px', // Reduced minimum height for each row
...
//                   const hasMore = allEntries.length >= 2; // Show dialog if 2+ entries
...
//                                 aria-label={`Show all entries for ${format(calDate, "PP")}`}
//                               >
//                                 See All
//                               </Button>
//                             </DialogTrigger>
